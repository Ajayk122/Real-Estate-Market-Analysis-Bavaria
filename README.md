...
**Model fit: R² = 0.43** - property size, location, and amenities together explain 43% of all rental price variation across Bavaria.

**Key findings:**
- **Apartment size (log_area)** is the dominant driver - 95% estimated rent premium, far above all other features
- **Lift access** adds 26% premium to cold rent
- **Balcony** adds 16% rental premium
- **Furnished apartments** command 10% higher rent
- **Cellar/Attic** adds 8% premium
- **Newly constructed** properties earn 6% premium
- **Balcony or Terrace** shows slight negative effect
